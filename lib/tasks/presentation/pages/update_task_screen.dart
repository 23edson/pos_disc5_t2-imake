                    ...
                    child: BlocConsumer<TasksBloc, TasksState>(listener: (context, state) {
                      ...
                      return ListView(
                        children: [
                          ...
                          const SizedBox(height: 20),
                          buildText(
                              'Title', kBlackColor, textMedium, FontWeight.bold, TextAlign.start, TextOverflow.clip),
                          const SizedBox(
                            height: 10,
                          ),
                          BuildTextField(
                          ...
                          buildText('Description', kBlackColor, textMedium, FontWeight.bold, TextAlign.start,
                              TextOverflow.clip),
                          const SizedBox(
                            height: 10,
                          ),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                                ...
                                child: Padding(
                                  ...
                                  child: buildText('Update', kWhiteColor, textMedium, FontWeight.w600, TextAlign.center,
                                      TextOverflow.clip),
                                )),
                          ),
                        ],
