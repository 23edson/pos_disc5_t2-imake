                    ...
                    child: BlocConsumer<TasksBloc, TasksState>(listener: (context, state) {
                      ...
                      return ListView(
                        children: [
                          ...
                          const SizedBox(height: 20),
                          buildText(
                              'Título', kBlackColor, textMedium, FontWeight.bold, TextAlign.start, TextOverflow.clip),
                          const SizedBox(
                            height: 10,
                          ),
                          BuildTextField(
                          ...
                          buildText('Descrição', kBlackColor, textMedium, FontWeight.bold, TextAlign.start,
                              TextOverflow.clip),
                          const SizedBox(
                            height: 10,
                          ),
                            ...
                            children: [
                              Expanded(
                                child: ElevatedButton(
                                    ...
                                    child: Padding(
                                      ...
                                      child: buildText('Cancelar', kBlackColor, textMedium, FontWeight.w600,
                              ...
                              Expanded(
                                child: ElevatedButton(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.all(15),
                                      child: buildText('Salvar', kWhiteColor, textMedium, FontWeight.w600,
                                          TextAlign.center, TextOverflow.clip),
                                    )),
                              ),
                            ],
