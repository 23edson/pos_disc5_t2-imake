                    ...
                    PopupMenuItem<int>(
                      ...
                      child: Row(
                        children: [
                          ...
                          buildText('Finalizadas', kBlackColor, textSmall, FontWeight.normal, TextAlign.start,
                              TextOverflow.clip)
                        ],
                      ),
                    ),
                    PopupMenuItem<int>(
                      ...
                      child: Row(
                        children: [
                          ...
                          buildText('Pendentes', kBlackColor, textSmall, FontWeight.normal, TextAlign.start,
                              TextOverflow.clip)
                        ],
                      ),
                    ),
          ...
          body: GestureDetector(
              ...
              child: Padding(
                  ...
                  child: BlocConsumer<TasksBloc, TasksState>(listener: (context, state) {
                    ...
                    if (state is LoadTaskFailure) {
                      return Center(
                        child: buildText(state.error, kBlackColor, textMedium, FontWeight.normal, TextAlign.center,
                            TextOverflow.clip),
                      );
                    }
                          ...
                          : Center(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  buildText('Agendar tarefas', kBlackColor, textBold, FontWeight.w600, TextAlign.center,
                                      TextOverflow.clip),
                                  buildText('Gerencie suas tarefas de forma eficiente', kBlackColor.withOpacity(.5),
                                      textSmall, FontWeight.normal, TextAlign.center, TextOverflow.clip),
                                ],
                              ),
                            );
                    }
