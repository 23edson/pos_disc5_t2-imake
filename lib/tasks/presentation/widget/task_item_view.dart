              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(
                          child: buildText(widget.taskModel.title, kBlackColor, textMedium, FontWeight.w500,
                            ...
                            PopupMenuItem<int>(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  buildText('Editar', kBlackColor, textMedium, FontWeight.normal, TextAlign.start,
                                      TextOverflow.clip)
                                ],
                              ),
                            ),
                            PopupMenuItem<int>(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  buildText('Excluir', kRed, textMedium, FontWeight.normal, TextAlign.start,
                                      TextOverflow.clip)
                                ],
                              ),
                            ),
